...
``` bash
    cellfinder -s /path/to/first/signal/channel.txt  /path/to/any/other/signal/channels.txt  -b /path/to/background/channel.txt -o /path/to/output_directory -x 0.001 -y 0.001 -z 0.005
```
